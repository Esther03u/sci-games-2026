...
> Last updated: 2026-09-24 (**นำไอคอนชนิดกีฬาและไอคอน Timer ออกจาก `/staff/scoring`**: ปรับแต่งหน้าจอบันทึกคะแนนสนามให้คลีน สบายตา ตัวหนังสือคมชัด ลดความรกตาตามความต้องการของผู้ใช้ + แยกระบบตามชนิดกีฬาเดี่ยว ใครได้กีฬาอะไรเห็นแค่กีฬานั้น 100%, Vitest 98 tests ผ่าน 100%, ESLint ผ่าน 0 errors, Prettier ผ่าน 100%, npm run build ผ่าน 100%)
...
- ✅ **นำไอคอนชนิดกีฬาและไอคอนหน้าหัวเรื่องออกจาก `/staff/scoring` ทั้งหมด (24 ก.ย.)**:
