...
> Last updated: 2026-09-25 (**นำฟอนต์ "Game of Squids" มาใช้กับแบรนด์และหัวข้อ "Sci Games 2026" บน Navbar, Hero Section และ Footer** · `GameOfSquids.woff2` & `.ttf` ใน `public/fonts/` · `@font-face` ใน `base.css` · `--font-squids` & `--font-brand` ใน `tokens.css` · `.hero-festival-title` ใน `public.css` · build ✅ · vitest 124/124 ✅ · lint 0/0 ✅)
