...
> Last updated: 2026-09-25 (**ปรับปรุงความสมดุลแถบเลือกวันแข่งขันในหน้า `/schedule` บนมือถือ: ปรับเป็น 5 คอลัมน์แถวเดียวพอดี ไม่ตกหล่นไปบรรทัดที่สอง พร้อมป้ายชื่อย่อ Responsive กะทัดรัดอ่านง่าย สวยงามลงตัว 100%** · build ✅ · vitest 124/124 ✅ · lint 0/0 ✅)
