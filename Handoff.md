...
> Last updated: 2026-09-25 (**อัปเดตไฟล์กำหนดการแข่งขันให้ดาวน์โหลด (`/docs/sci-games-2026-schedule.pdf`) เป็นฉบับทางการใหม่ 3 หน้า (141 KB) ตรงตามไฟล์ที่ผู้ใช้อัปโหลดล่าสุด พร้อมปรับ Metadata ครบถ้วน** · build ✅ · vitest 124/124 ✅ · lint 0/0 ✅)
