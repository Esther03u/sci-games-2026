...
> Last updated: 2026-09-24 (**ปรับปรุงระบบเลือกลงคะแนนสนาม `/staff/scoring`**: เพิ่มแถบตัวกรองชนิดกีฬา Sport Pills + แถบกรองวันแข่ง Date Pills + ช่องค้นหาด่วน + การ์ดแมตช์รูปแบบใหม่พร้อมปุ่ม "แตะเพื่อลงคะแนน →" + แถบอธิบายสิทธิ์ Admin และวิธีทดสอบ PIN กรรมการ, Vitest 98 tests ผ่าน 100%, ESLint ผ่าน 0 errors, npm run build ผ่าน 100%)
...
- ✅ **ปรับปรุงระบบเลือกลงคะแนนสนาม (`/staff/scoring`) ให้ใช้งานง่ายและค้นหาได้ทันที (24 ก.ย.)**:
