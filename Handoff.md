...
> Last updated: 2026-09-25 (**เพิ่มฟอนต์ Super Mario 256 สำหรับหัวข้อ "Sci Games 2026" ใน Hero Section** · `SuperMario256.woff2` & `.ttf` ใน `public/fonts/` · `@font-face` ใน `base.css` · `--font-super-mario` ใน `tokens.css` · `.hero-festival-title` ใน `public.css` · build ✅ · vitest 124/124 ✅ · lint 0/0 ✅)
