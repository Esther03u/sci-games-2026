...
- ✅ **บูรณาการคอมโพเนนต์ `<FolderFloat />` จาก React Bits & Matter.js Zero-Gravity Physics (25 ก.ย.)**:
  ...
  - เพิ่มระยะเว้นว่างด้านบน (`margin-top: 8.5rem`, `lift={14}`) ป้องกันการ์ดลอยขึ้นไปบดบังหัวข้อหลัก "Sci Games 2026"
  - ติดตั้งระบบ IntersectionObserver: แสดงอนิเมชันเปิดแฟ้มและการ์ดลอยออกมาเองอัตโนมัติเมื่อเลื่อนจอมาถึง (Auto In-View Animation) โดยไม่ต้องคลิก
