...
> Last updated: 2026-09-23 (อ่านสูจิบัตร+กำหนดการฉบับจริงใน final/ แล้ววางแผนสลับไปใช้ข้อมูลจริง — docs/plans/2026-09-23-real-data-switch.md รอผู้ใช้ตัดสินใจ 5 ข้อ)
...
| ลำดับ | งาน | หมายเหตุ |
|---|---|---|
| 0 | **สลับไปใช้ข้อมูลจริงจากสูจิบัตร/กำหนดการ** | แผนเต็ม: `docs/plans/2026-09-23-real-data-switch.md` — P0: seeder ไม่เขียน bracket links, DB ยังเป็นชุดเก่า, เวลาตะกร้อผิด 3 คู่, กติกาตะกร้อ/เปตองผิด |
