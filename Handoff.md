...
| **ผู้ชมไม่เห็นคะแนนสด (ตัดสินใจ 22 ก.ย.)** | ผู้ชมดูที่ `/results` — แมตช์ที่กำลังแข่งขึ้นสถานะ "กำลังแข่ง" **โดยไม่แสดงคะแนน** จนกว่าจะจบ; ลิงก์ "ผลสด" ถูกถอดจาก Navbar/Bottom nav/หน้าแรกแล้ว (route `/live` ยังเข้าได้ทาง URL — ใช้ภายใน/จอสนาม) — **อย่าเพิ่มคะแนนสดกลับเข้าหน้าบ้าน** |
