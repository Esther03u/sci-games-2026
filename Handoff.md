...
> Last updated: 2026-09-25 (**เปลี่ยนฟอนต์คำว่า "Sci Games 2026" หน้าบ้านทั้งเว็บเป็น Platinum Sign** · `PlatinumSign.woff2` (6.2KB) & `.ttf` ใน `public/fonts/` · map lowercase ในฟอนต์ครบทุกตัวอักษร · `@font-face` ใน `base.css` · คลาส `.font-brand` & ตัวแปร `--font-brand` · นำไปใช้ใน Navbar, Hero Section, FolderFloat, Footer, Handbook, Results, News, MatchDetailModal, และหน้าแรก · build ✅ · vitest 124/124 ✅ · lint 0/0 ✅)
...
- ✅ **เปลี่ยนฟอนต์คำว่า "Sci Games 2026" บนหน้าบ้านทั้งเว็บเป็น "Platinum Sign" (25 ก.ย.)**:
  - ดำเนินการตามคำขอของผู้ใช้: *"เปลี่ยนคำว่า Sci Games 2026 หน้าบ้านทั้งเว็บให้ใช้ font นี้ https://www.dafont.com/platinum-sign.font"*
  - **เตรียมไฟล์ฟอนต์คุณภาพสูง (`public/fonts/`)**: ดาวน์โหลด `Platinum Sign` จาก DaFont, ทำการ map ตัวพิมพ์เล็ก `a-z` ในตาราง cmap ให้ชี้ไปยัง glyphs ตัวพิมพ์ใหญ่ครบถ้วนเพื่อไม่ให้ตัวอักษรตกหล่น, แปลงเป็น `PlatinumSign.woff2` (ขนาดเพียง 6.2 KB) และ `.ttf`
  - **ตั้งค่าระบบสไตล์ (`base.css`, `tokens.css`, `components.css`)**: ประกาศ `@font-face` ใน `base.css`, ตัวแปร `--font-platinum-sign` และ `--font-brand` ใน `tokens.css`, เพิ่มคลาสอรรถประโยชน์ `.font-brand` ใน `components.css`
  - **นำไปใช้กับคำว่า "Sci Games 2026" ทั่วหน้าบ้าน**:
    - Navbar (`Navbar.js`): ชื่อแบรนด์หลักมุมบนซ้าย "Sci Games 2026"
    - Hero Section (`HeroSection.js` & `public.css`): หัวข้อหลัก `.hero-festival-title` พร้อมปี 2026 ไล่เฉดทอง
    - Folder Float (`FolderFloat.css`): ป้ายชื่อแฟ้ม "Sci Games 2026"
    - Footer (`Footer.js`): แบรนด์ "Sci Games 2026" ส่วนท้ายเว็บ
    - Handbook Hub (`HandbookHub.js`): ป้าย "เอกสารทางการ Sci Games 2026"
    - Results Board (`ResultsBoard.js`): คำอธิบายหัวข้อผลการแข่งขัน
    - News (`news/page.js`): คำอธิบายหัวข้อข่าวสาร
    - Match Detail Modal (`MatchDetailModal.js`): ป้ายชื่อในโมดอลการแข่งขัน
    - Home Page (`(public)/page.js`): ข้อความใต้โพเดียมอันดับคะแนน
