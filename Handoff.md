...
> Last updated: 2026-09-25 (**แก้ปัญหาการ์ดลอยบดบังหัวข้อหลัก "Sci Games 2026" ปรับระยะ Headroom และจัดเรียง 2 แถวกระชับ พร้อมแอนิเมชันอัตโนมัติเมื่อเลื่อนจอมาถึง** · **บูรณาการคอมโพเนนต์ `<FolderFloat />` จาก React Bits ด้วย Matter.js Physics ใน Hero Section** · **คะแนนรวมตามอันดับที่ 1–4 + หน้าจับคู่สาขาเป็นการ์ดสี** — ตั้งคะแนนได้ที่ /admin/settings, ผู้ชมเห็นคะแนนรวมหลังเปิดโพเดียม, สาขาบนหน้าแรกปิดไว้จนข้อมูลถูก · บูรณาการ Motion motion.dev ให้เว็บลื่นไหล สมูท เป็นธรรมชาติทุกจุด · 44/44 แมตช์ครบสมบูรณ์ · PIN `kim` และบัญชี `ProgCheck` เก็บไว้ตามเดิม)
